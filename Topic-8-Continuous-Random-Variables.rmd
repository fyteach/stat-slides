...
puniform <- ggplot(
  ...
  theme(
    ...
    plot.title = element_text(hjust = 0.5, size=16), panel.border = element_blank(),
...
:::: {.row}
::: {.pull-left}
**Solution:** The probability $P(X\leq 4)$ is the area under the horizontal line $y=0.1$ to the left of $X=4$. 

Since $f(X)=0$ for $X<0$, the area is the area of the rectangle with width 4 and height 0.1. So the probability is $P(X\leq 4)=0.1\cdot 4=0.4$.
:::

::: {.pull-right}
```{r eg_uniform, echo=FALSE, fig.width=5, fig.asp=0.5, fig.align="center", warning=FALSE, out.width = "90%", fig.cap =""}
puniform <- ggplot(
...
::: {.center}
```{r normal_curves_sigma=1, echo=FALSE, fig.width=6, fig.asp=0.5, out.width = "45%", warning=FALSE, dpi = 200, fig.cap = ""}
m1 <-0
m2 <- 1
m3 <- -1.5
mn <- c(m1, m2, m3)
...
pmean
```
```{r normal_curves_mean=0, echo=FALSE, fig.width=6, fig.asp=0.5, out.width = "45%", warning=FALSE, dpi = 200, fig.cap = ""}
sd1 <- 0.6
sd2 <- 1.5
sd3 <- 2
sd <- c(sd1, sd2, sd3)
...
::: {.center}
```{r empirical_normal, echo=FALSE, fig.width=8, fig.asp=0.6, out.width = "60%", fig.cap = ""}
sgma=1.5
...
::: {.center}
```{r eg_foot_length_1, echo=FALSE, fig.width=6, fig.asp=0.5, out.width = "40%", fig.cap = ""}
footsigma <- 1.5
footmu <- 11
...
```
```{r eg_foot_length_2, echo=FALSE, fig.width=6, fig.asp=0.5, out.width = "40%", fig.cap = ""}
footsigma <- 1.5
footmu <- 11
footbr <- c(-2, -1, 0, 1, 2)*footsigma+footmu
