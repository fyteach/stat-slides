...
- A **two-way relative frequency table:** two-way table with relative frequencies.
...
## Example: Probabilities about Body and Gender
...
## Example: Community College Enrollment (1 of 2)
...
## Example: Community College Enrollment (2 of 2)
...
## Practice: Weights and Heights {.unnumbered}
...
- To quantify these differences objectively, we use a statistic based on how far observed proportions deviate from what independence predicts. Numerically, association can be measured by the normalized sum of squared standardized residuals: where larger values indicate stronger association (for more information, see <https://en.wikipedia.org/wiki/Cram%C3%A9r%27s_V>).

---

## Example: Association Between Body and Gender (1 of 2)
...
## Example: Association Between Body and Gender (2 of 2)
...
::: {.center}
![Stacked Bar Chart for Gender and Body Images](Figures/Gender-Body.png){width="75%"}
:::
...
## Example: Physicians’ Health Study (1 of 2)
...
## Example: Physicians’ Health Study (2 of 2)
...
The percentage reduction of risk is
$$
\frac{P(\text{heart attack}|\text{aspirin})-P(\text{heart attack}|\text{placebo})}{P(\text{heart attack}|\text{placebo})}=\frac{\text{0.013}-\text{0.022}}{\text{0.022}}=\frac{-\text{0.009}}{\text{0.022}}\approx -\text{0.41}.
$$
...
## Example: Birth Gender Prediction (1 of 3)
...
## Example: Birth Gender Prediction (2 of 3)
...
## Example: Birth Gender Prediction (3 of 3)
...
## Practice: Highway Safty {.unnumbered}
...
## Practice: Drug Screening {.unnumbered}
...
## Lab Practice: Gender vs Program Selection {.unnumbered}
