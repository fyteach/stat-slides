...
- **Variable:** a characteristic or attribute of interest measured on individuals or objects. Variables are commonly classified by the type of values they take:
  
  - **Categorical variables** (or qualitative variables) represent attributes, labels or nonnumerical entries, such as names, and colors. Differences or ratios are not meaningful.
  - **Numerical variables** (or quantitative variables) represent numerical measurements or counts, such as weights and number of students in each class. Differences and ratios must be meaningful.

- **Univariate data:** a collection of observations on a single variable.
- **Bivariate data:** a collection of paired observations of two variables.
- **Multivariate data:** a collection of observations on three or more variables.
...
::: {.iframecontainer}
<iframe src="https://www.myopenmath.com/embedq2.php?id=277257&seed=2024&showansafter" width="100%" loading="lazy" allowfullscreen title="MyOpenMath question"></iframe>
:::
...
- In cause-and-effect study, an **explanatory variable** is a cause, and the **response variable** is the effect. 
  To properly establish cause and effect relationship, researchers try to remove **extraneous variables** which are variables other than the explanatory variables that may affect the response.
...
::: {.iframecontainer}
<iframe src="https://www.myopenmath.com/embedq2.php?id=384958&seed=2024&showansafter" width="100%" loading="lazy" allowfullscreen title="MyOpenMath question"></iframe>
:::
...
::: {.iframecontainer}
<iframe src="https://www.myopenmath.com/embedq2.php?id=307471&seed=2024&showansafter" width="100%" loading="lazy" allowfullscreen title="MyOpenMath question"></iframe>
:::
...
## Mini‑example of Experimental Design
...
## Example: Does the Study Support the Conclusion?
...
## Example: Is the Conclusion Appropriate?


A teacher read about a study testing whether the background color of a digital reading passage affects reading speed. In the study, 80 students read the same passage and were randomly assigned to:
Group A (40 students) with white background; Group B (40 students) with light yellow background.  
...
::: {.iframecontainer}
<iframe src="https://www.myopenmath.com/embedq2.php?id=438624&seed=2024&showansafter" width="100%" loading="lazy" allowfullscreen title="MyOpenMath question"></iframe>
:::
